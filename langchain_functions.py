...
metadata_field_info1 = [
    ...
    AttributeInfo(
        name="bias_label",
        description="기사의 정치적 편향도를 0과 1사이의 값으로 수치화한 것이다. 그 수치가 1에 가까울 수록 보수적이며, 0에 가까울 수록 진보적이라고 해석된다.",
        type="float",
    ),
    AttributeInfo(
        name="content_url",
...
sqretriever1 = SelfQueryRetriever.from_llm(llm1,db1,document_content_description1,metadata_field_info1,verbose=True)
sqretriever2 = SelfQueryRetriever.from_llm(llm2,db2,document_content_description2,metadata_field_info2,verbose=True)
